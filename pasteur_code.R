...
#' 
#' @description complications_number function gets data on all complications listed in the crf09 form, counts the number of complications in each row, and then calculates the total number of complications for each study_id
#' 
#' @return
#' @export
#' 
...
pasteur_complications_number <- function(){
  ...
  df <- get_data(c("study_id","cfu_comp_prompt___1", "cfu_comp_prompt___2", "cfu_comp_prompt___3", 
                   "cfu_comp_prompt___4", "cfu_comp_prompt___5", "cfu_comp_prompt___6", "cfu_comp_prompt___13", 
                   "cfu_comp_prompt___7", "cfu_comp_prompt___8", "cfu_comp_prompt___9", "cfu_comp_prompt___10", 
                   "cfu_comp_prompt___11", "cfu_comp_prompt___12", "cfu_comp_prompt___20", "cfu_comp_prompt___501", 
                   "cfu_comp_prompt___502", "cfu_comp_prompt___503", "cfu_comp_prompt___504"))
  
  df <- df %>%
    mutate(across(cfu_comp_prompt___1:cfu_comp_prompt___504, as.numeric)) %>%
    mutate(total_complications = rowSums(across(where(is.numeric)), na.rm = T)) %>%
    group_by(study_id) %>%
    mutate(total_complications = sum(total_complications, na.rm = T)) %>%
    distinct(study_id, .keep_all = T) %>%
    select(study_id, total_complications)
